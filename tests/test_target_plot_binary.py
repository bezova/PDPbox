...
def test_endpoint(titanic_data, titanic_target):
    ...
    expected = pd.DataFrame(
        {'x': {0: 0, 8: 8, 9: 9},
         'display_column': {0: '[0.00, 7.73)', 8: '[73.50, 512.33)',
                            9: '>= 512.33'},
...
def test_grid_range_outliers(titanic_data, titanic_target):
    ...
    expected = pd.DataFrame(
        {'x': {0: 0, 8: 8, 9: 9},
         'display_column': {0: '[0.00, 11.11)', 8: '[88.89, 100.00]',
                            9: '> 100.00'},
...
def test_cust_grid_outliers(titanic_data, titanic_target):
    ...
    expected = pd.DataFrame(
        {'x': {0: 0, 8: 8, 9: 9},
         'display_column': {0: '[0.00, 10.00)', 8: '[80.00, 90.00]',
                            9: '> 90.00'},
...
def test_percentile_range_outliers(titanic_data, titanic_target):
    ...
    expected = pd.DataFrame(
        {'x': {0: 0, 5: 5, 10: 10},
         'display_column': {0: '< 7.22', 5: '[13.00, 16.10)', 10: '> 112.08'},
...
def test_percentile_range_outliers_endpoint(titanic_data, titanic_target):
    ...
    expected = pd.DataFrame(
        {'x': {0: 0, 9: 9, 10: 10},
         'display_column': {0: '< 7.22', 9: '[56.50, 112.08)', 10: '>= 112.08'},
